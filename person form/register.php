...
<head>
  ...
  <style>
    ...
    .register-form .input-group.email::before {
      background-image: url('https://img.icons8.com/ios-glyphs/30/000000/email.png');
    }

    .register-form .input-group.role::before {
      background-image: url('https://img.icons8.com/ios-glyphs/30/000000/user.png');
    }

    .register-form .input-group.password::before {
...
<body>
  ...
  <div class="register-container">
    ...
    <form class="register-form" action="database.php" method="POST">
      <h2>Register</h2>
